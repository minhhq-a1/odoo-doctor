...
def test_load_config_child_overrides_parent(tmp_path: Path):
...
def test_load_config_stops_at_filesystem_root(tmp_path: Path):
    """No config anywhere should return defaults without crashing."""
    deep = tmp_path / "a" / "b" / "c"
...
def test_load_config_no_parent_walk_when_local_exists(tmp_path: Path):
